...
参考として、著者の1人（1,050件）の実績では次のような経過でした。
...
**実測値つき**で紹介します。件数は著者の1人（情報系・日本、最終1,050件）の場合です。

### researchmap — 日本の研究者なら最優先
...
**最終1,050件のうち925件、9割がこれだけで揃いました。** researchmap を更新している人にとっては、ここが圧倒的に効率的な入口です。
...
**国際APIだけでは全体の約40%です。** 国内会議・研究会（この例では540件）はどこにも載っていません。日本の研究者が国際APIだけで済ませようとすると、業績の半分が抜けます。
...
著者の1人は、一括登録時に全1,050件にこれが付いていたことに後から気づきました。業績リストは公開前提の情報なので実害は薄く、むしろCVとして公開するのは自然ですが、**意図せずそうなっている可能性**は知っておくべきです。
...
*この文書は、実際に1,050件を集約した際に遭遇した問題をもとに書かれています。数値はすべて実測値です。*
